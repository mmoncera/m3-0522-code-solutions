...
export default class App extends React.Component {
  ...
  toggleCompleted(todoId) {
     ...
     * And specify the "Content-Type" header as "application/json"
     */
    const matchingIndex = this.state.todos.findIndex(element => element.todoId === todoId);
    const isCompleted = this.state.todos[matchingIndex].isCompleted;
    const toggleIsCompleted = { isCompleted: !isCompleted };
